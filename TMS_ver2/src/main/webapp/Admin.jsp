...
<body class="fixed-left">
			...
			<div class="sidebar-inner slimscrollleft">
				...
				<div id="sidebar-menu">
					<ul>
						...
						<li><a id="Admin_Dashboard" class="waves-effect active"><i
								class="zmdi zmdi-view-dashboard"></i> <span> Dashboard </span> </a>
						</li>

						<li><a id="Admin_Trainer" class="waves-effect"><i
								class="zmdi zmdi-format-underlined"></i> <span> Trainer
									Account </span> </a></li>

						<li><a id="Admin_Staff" class="waves-effect"><i
								class="zmdi zmdi-format-underlined"></i> <span> Staff
									Account </span> </a></li>
	...
	<!-- init -->
	<script src="assets/pages/jquery.admin.menu.js"></script>
