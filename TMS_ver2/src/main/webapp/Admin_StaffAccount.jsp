...
<body class="fixed-left">
									...
									<div class="row">
										...
										<div class="col-sm-3">
											<div class="dataTables_length" id="datatable-editable_length">
												<label>Show 
													<select name="datatable-editable_length" 
											...
											<tbody>
												<tr class="gradeX">
													...
													<td class="actions">
														...
														<a href="#" class="on-default del-row"><i class="fa fa-trash-o"></i></a> 
														<a href="#" class="on-default view-row"><i class="fa fa-eye"></i></a></td>
												</tr>
												<tr class="gradeC">
													<td class="img"><img src="assets/images/users/avatar-3.jpg"
														class="img-responsive img-circle" style="width: 40px"></td>
											...
											<div class="dataTables_paginate paging_simple_numbers" 
												...
												<ul class="pagination">
													<li class="paginate_button previous disabled" 
														...
														id="datatable-editable_previous">
														<a href="#">Previous</a></li>
													<li class="paginate_button active" 
														aria-controls="datatable-editable" tabindex="0">
														<a href="#">1</a></li>
													<li class="paginate_button " aria-controls="datatable-editable" 
			...
			<div class="modal-dialog">
				...
				<div class="modal-content modalDS-content">
					...
					======== -->
						...
						<form id="form-View" class="form-horizontal group-border-dashed" action="#">
							<h3 style="text-align: center">Account</h3>
							<div class="form-group form-account">
								<label class="col-sm-6 control-label labelDS-center">UserName</label> <label
									class="col-sm-6 control-label labelDS-center">Password</label>
							</div>
					...
					<!--  ========
					 ...
					 ======== -->
						...
						<form id="form-Edit" class=" hidden form-horizontal group-border-dashed" action="#">
							<h3 style="text-align: center">Account</h3>
							<div class="form-group form-account">
								<label class="col-sm-6 control-label labelDS-center">UserName</label> <label
									class="col-sm-6 control-label labelDS-center">Password</label>
	...
	<script src="assets/pages/jquery.admin.staff.js"></script>
